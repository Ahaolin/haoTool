...
import com.haolin.dubbo.common.util.CollectionUtils;
import com.haolin.dubbo.common.util.NetUtils;
...
public final class URL implements Serializable {
    ...
    public String getServiceKey() {
        ...
        StringBuilder buf = new StringBuilder();
        String group = getParameter(CommonConstants.GROUP_KEY);
        if (group != null && group.length() > 0) {
            buf.append(group).append("/");
        }
        buf.append(inf);
        String version = getParameter(CommonConstants.VERSION_KEY);
